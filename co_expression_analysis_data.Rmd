...
pwbc_6_count_filtered$geneID<-rownames(pwbc_6_count_filtered)

pwbc_6_count_data_annotated<-merge(pwbc_6_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
pwbc_6_count_filtered<-pwbc_6_count_filtered[, -ncol(pwbc_6_count_filtered)]
```

```{r}
write_delim(pwbc_6_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/pwbc_6_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
pwbc_9_count_filtered$geneID<-rownames(pwbc_9_count_filtered)

pwbc_9_count_data_annotated<-merge(pwbc_9_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
pwbc_9_count_filtered<-pwbc_9_count_filtered[,-ncol(pwbc_9_count_filtered)]
```

```{r}
write_delim(pwbc_9_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/pwbc_9_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
pwbc_19_count_filtered$geneID<-rownames(pwbc_19_count_filtered)

pwbc_19_count_data_annotated<-merge(pwbc_19_count_filtered,
                                         annotation.ensembl.symbol,
                                         by.x="geneID",
                                         by.y="ensembl_gene_id",
                                         all.x=FALSE, 
                                         all.y=FALSE)
pwbc_19_count_filtered<-pwbc_19_count_filtered[,-ncol(pwbc_19_count_filtered)]
```

```{r}
write_delim(pwbc_19_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/pwbc_19_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
endometrium_6_count_filtered$geneID<-rownames(endometrium_6_count_filtered)

endometrium_6_count_data_annotated<-merge(endometrium_6_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
endometrium_6_count_filtered<-endometrium_6_count_filtered[, -ncol(endometrium_6_count_filtered)]
```

```{r}
write_delim(endometrium_6_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/endometrium_6_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
endometrium_9_count_filtered$geneID<-rownames(endometrium_9_count_filtered)

endometrium_9_count_data_annotated<-merge(endometrium_9_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
endometrium_9_count_filtered<-endometrium_9_count_filtered[,-ncol(endometrium_9_count_filtered)]
```

```{r}
write_delim(endometrium_9_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/endometrium_9_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
endometrium_19_count_filtered$geneID<-rownames(endometrium_19_count_filtered)

endometrium_19_count_data_annotated<-merge(endometrium_19_count_filtered,
                                         annotation.ensembl.symbol,
                                         by.x="geneID",
                                         by.y="ensembl_gene_id",
                                         all.x=FALSE, 
                                         all.y=FALSE)
endometrium_19_count_filtered<-endometrium_19_count_filtered[,-ncol(endometrium_19_count_filtered)]
```

```{r}
write_delim(endometrium_19_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/endometrium_19_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
hypothalamus_6_count_filtered$geneID<-rownames(hypothalamus_6_count_filtered)

hypothalamus_6_count_data_annotated<-merge(hypothalamus_6_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
hypothalamus_6_count_filtered<-hypothalamus_6_count_filtered[, -ncol(hypothalamus_6_count_filtered)]
```

```{r}
write_delim(hypothalamus_6_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/hypothalamus_6_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
hypothalamus_9_count_filtered$geneID<-rownames(hypothalamus_9_count_filtered)

hypothalamus_9_count_data_annotated<-merge(hypothalamus_9_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
hypothalamus_9_count_filtered<-hypothalamus_9_count_filtered[,-ncol(hypothalamus_9_count_filtered)]
```

```{r}
write_delim(hypothalamus_9_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/hypothalamus_9_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
hypothalamus_19_count_filtered$geneID<-rownames(hypothalamus_19_count_filtered)

hypothalamus_19_count_data_annotated<-merge(hypothalamus_19_count_filtered,
                                         annotation.ensembl.symbol,
                                         by.x="geneID",
                                         by.y="ensembl_gene_id",
                                         all.x=FALSE, 
                                         all.y=FALSE)
hypothalamus_19_count_filtered<-hypothalamus_19_count_filtered[,-ncol(hypothalamus_19_count_filtered)]
```

```{r}
write_delim(hypothalamus_19_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/hypothalamus_19_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
pituitary_6_count_filtered$geneID<-rownames(pituitary_6_count_filtered)

pituitary_6_count_data_annotated<-merge(pituitary_6_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
pituitary_6_count_filtered<-pituitary_6_count_filtered[, -ncol(pituitary_6_count_filtered)]
```

```{r}
write_delim(pituitary_6_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/pituitary_6_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
pituitary_9_count_filtered$geneID<-rownames(pituitary_9_count_filtered)

pituitary_9_count_data_annotated<-merge(pituitary_9_count_filtered,
                                        annotation.ensembl.symbol,
                                        by.x="geneID",
                                        by.y="ensembl_gene_id",
                                        all.x=FALSE, 
                                        all.y=FALSE)
pituitary_9_count_filtered<-pituitary_9_count_filtered[,-ncol(pituitary_9_count_filtered)]
```

```{r}
write_delim(pituitary_9_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/pituitary_9_count_annotated.txt",
            delim = "\t",
            quote =  "none")
...
pituitary_19_count_filtered$geneID<-rownames(pituitary_19_count_filtered)

pituitary_19_count_data_annotated<-merge(pituitary_19_count_filtered,
                                         annotation.ensembl.symbol,
                                         by.x="geneID",
                                         by.y="ensembl_gene_id",
                                         all.x=FALSE, 
                                         all.y=FALSE)
pituitary_19_count_filtered<-pituitary_19_count_filtered[,-ncol(pituitary_19_count_filtered)]
```

```{r}
write_delim(pituitary_19_count_data_annotated,
            "/home/yassine/Downloads/between_tissue/pituitary_19_count_annotated.txt",
            delim = "\t",
            quote =  "none")
